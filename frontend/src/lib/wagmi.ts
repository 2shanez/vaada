...
export const CONTRACTS = {
  [base.id]: {
    ...
    newUserChallenge: '0xB77e1FFa0be50E0B867c8f9CcdDBd1a88D354824' as `0x${string}`, // NewUserChallenge V4 (no Chainlink, selfSettle + adminSettle)
    vaadaReceipts: '0x2743327fa1EeDF92793608d659b7eEC428252dA2' as `0x${string}`, // VaadaReceipts (soulbound)
  },
}
