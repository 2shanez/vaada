...
export async function GET(
  ...
  <text x="48" y="72" font-family="Inter, system-ui, sans-serif" font-size="32" font-weight="700" fill="#2EE59D">vaada</text>
  <rect x="580" y="42" width="172" height="36" rx="18" fill="rgb(${statusBgR},${statusBgG},${statusBgB})" fill-opacity="0.15"/>
  <text x="666" y="66" font-family="Inter, system-ui, sans-serif" font-size="16" font-weight="600" fill="${statusColor}" text-anchor="middle">${statusIcon} ${statusText}</text>
  
  <text x="48" y="190" font-family="Inter, system-ui, sans-serif" font-size="48" font-weight="700" fill="white">${goalName}</text>
  <text x="48" y="230" font-family="Inter, system-ui, sans-serif" font-size="22" fill="white" fill-opacity="0.6">${actual.toLocaleString()} / ${target.toLocaleString()} ${unit} - ${pct}%</text>
  ...
  <text x="48" y="370" font-family="Inter, system-ui, sans-serif" font-size="16" fill="white" fill-opacity="0.4">Staked</text>
  <text x="48" y="402" font-family="Inter, system-ui, sans-serif" font-size="28" font-weight="700" fill="white">$${stakeUSD} USDC</text>
  
  <text x="752" y="380" font-family="Inter, system-ui, sans-serif" font-size="14" fill="white" fill-opacity="0.4" text-anchor="end">${shortAddr} - ${date}</text>
  <text x="752" y="402" font-family="Inter, system-ui, sans-serif" font-size="14" fill="white" fill-opacity="0.3" text-anchor="end">Proof #${id} on Base</text>
</svg>`
